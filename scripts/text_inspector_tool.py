...
This tool handles the following file extensions: [".html", ".htm", ".xlsx", ".pptx", ".wav", ".mp3", ".flac", ".pdf", ".docx"], and all other types of text files. IT DOES NOT HANDLE IMAGES."""
    ...
    def __init__(self, model: Model, text_limit: int):
        ...
        logger.info(f'TextInspectorTool initialisiert mit text_limit={text_limit}')

    def forward_initial_exam_mode(self, file_path, question):
        logger.debug(f'forward_initial_exam_mode: file_path={file_path}, question={question}')
        try:
            ...
            logger.error(f"Fehler in forward_initial_exam_mode: {e}")
